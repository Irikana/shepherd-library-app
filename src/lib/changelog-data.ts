...
export const CHANGELOG_DATA: ChangelogEntry[] = [
  ...
  },
  {
    ...
    "blocks": [
      ...
      {
        "kind": "bullet",
        "text": "**相关词条与图谱节点自动汇总**：从正文里的站内链接提取生成，无需另填"
      },
      {
        "kind": "bullet",
      ...
      {
        "kind": "bullet",
        "text": "牧羊人图书馆站点升至 **alpha-023**：新增分级提示构件（提示 / 通知 / 警告 × 小弹窗 / 模态弹窗 / 轻提示，带「关闭后今日不再提示」与每日 0 点自动恢复）、顶栏历史导航（返回上一页 / 前进到刚才那一页）、知识馆侧边栏改为主题令牌驱动并可收缩；修复移动端顶栏未展开即撑高、海报新闻日期不居中；《Minesia 第一个公开测试》由测试文章归位为普通文章。App 的知识词条模板与这些改动逐字对齐"
      }
    ]
  }
];
